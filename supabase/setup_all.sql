...
-- =====================================================================
--
-- Este archivo concatena, EN ORDEN, las 17 migraciones del esquema
-- (0001 -> 0017) y luego los datos de prueba (seed.sql). Esta pensado
-- para pegarse UNA sola vez en el SQL Editor de Supabase y ejecutarse
-- de corrido, dejando la base lista con esquema + RLS + datos demo.
--
-- Como usarlo:
--   1. Supabase Dashboard -> SQL Editor -> New query.
--   2. Pega TODO este archivo y pulsa Run. Debe terminar en "Success".
--   3. (Manual, no por SQL) Crea los usuarios de Auth y sus memberships:
--      ver la seccion 5 de SUPABASE_SETUP.md. El seed deja comentado un
--      bloque de memberships con los UUID de ejemplo.
--
-- Notas:
--   * Es idempotente en su mayoria (create ... if not exists, on conflict),
--     pero el seed puede duplicar filas en tablas sin clave unica si lo
--     corres dos veces. Ejecuta este archivo una sola vez.
--   * No incluye usuarios de Auth ni Edge Functions (ver SUPABASE_SETUP.md
--     secciones 5 y 8).
--
